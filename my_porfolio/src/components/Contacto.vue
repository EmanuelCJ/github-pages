<template>
  <section id="educacion" class=" text-white py-16 px-4 sm:px-6 lg:px-8">
    <div class="container mx-auto max-w-4xl">
      <h2 class="text-center text-3xl sm:text-4xl font-extrabold mb-8 sm:mb-12 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">
        ¿Tienes alguna pregunta o comentario? ¡Escríbeme!
      </h2>
      <div id="contacto" class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-2xl overflow-hidden shadow-2xl">
